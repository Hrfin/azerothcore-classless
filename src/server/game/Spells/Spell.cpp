...
void Spell::SendSpellGo()
{
    ...
    if ((m_caster->GetTypeId() == TYPEID_PLAYER)
            && (m_caster->IsClass(CLASS_DEATH_KNIGHT, CLASS_CONTEXT_ABILITY) || m_caster->IsClass(CLASS_HERO, CLASS_CONTEXT_ABILITY))
...
{
    if (m_caster->GetTypeId() != TYPEID_PLAYER || !(m_caster->IsClass(CLASS_DEATH_KNIGHT, CLASS_CONTEXT_ABILITY) || m_caster->IsClass(CLASS_HERO, CLASS_CONTEXT_ABILITY)))
        return;
